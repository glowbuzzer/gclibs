...
// TODO: M: update gbem with new define, FAULT_CAUSE_GBC_INTERNAL_ERROR_BIT_NUM is deprecated
#define FAULT_CAUSE_GBC_INTERNAL_ERROR_BIT_NUM          (FAULT_CAUSE_GBC_OPERATION_ERROR_BIT_NUM)

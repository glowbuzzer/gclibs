...
#define CTRL_GBC_INTERNAL_FAULT_REQ_BIT_NUM                 (16)
#define CONTROL_WORD_GBEM_START_HOMING_BIT_NUM              (17)
#define CTRL_MACHINE_CTRL_WRD_REQUEST_FAULT_BIT_NUM         (18)
#define CTRL_MOVE_NOT_OP_ENABLED_FAULT_REQ_BIT_NUM          (19)
